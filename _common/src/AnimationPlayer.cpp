...
void AnimationPlayer::calculateBoneTransforms(const AssimpNodeData* node, glm::mat4 parentTransform) {
    ...
    if(boneInfoMap.find(nodeName) != boneInfoMap.end()) {
        ...
        finalBoneMtx[index] = currentAnimation->getGlobalInverseTransform() * globalTransform * boneInfoMap.at(nodeName).offsetMtx;
    }
